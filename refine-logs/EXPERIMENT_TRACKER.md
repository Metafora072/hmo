...
| HMO-LL-C | fresh shorter-context layer-local confirmation | Qwen3.5-9B, 4 tasks x 20 frozen unseen cases, legacy/layer-local/ChunkKV/Full | FROZEN; 80 inputs selected without QA outcomes or probe scores, GPU1 execution pending |
