...
> **历史文档 / 已退役入口**：本文件描述 V6.1 的 E1--E6 实验，不是当前最终
> HMO 方法的 C3 协议。新的 27B/32K 实验只使用
> [`C3_27B_ONE_SHOT_RUNBOOK.md`](C3_27B_ONE_SHOT_RUNBOOK.md) 和
> `phase2/run_c3_27b.sh`。不要把两套命令或结果目录混用。
